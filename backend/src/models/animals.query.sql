...
CREATE TABLE animals (
    ...
    photo LONGBLOB NULL,
    sound LONGBLOB NULL,
    id_ctlg_type_specie INT(11) NOT NULL,
    id_users INT(11) NOT NULL,
    id_ctlg_scientific_name INT(11) NOT NULL,
    ...
    FOREIGN KEY (id_ctlg_scientific_name) REFERENCES ctlg_scientific_name_animal(id),
